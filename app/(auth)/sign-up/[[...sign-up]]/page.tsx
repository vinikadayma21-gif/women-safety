...
// Clerk's <SignUp /> handles phone OTP, Google OAuth, and email magic links.
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(circle, rgba(99, 102, 241, 0.07) 0%, rgba(16, 185, 129, 0.04) 50%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
